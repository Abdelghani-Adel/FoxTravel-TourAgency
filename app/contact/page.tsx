"use client";
import SocialMediaLinks from "@/components/layout/MainFooter/SocialMediaLinks";
      ...
      <div className="section">
        <div className="container">
          ...
          <h2 className="text-center mt-4 mb-2">
            We provide tours, packages and more ...
          </h2>

          <div className="row">
            <div className="col-12 col-md-6 m-auto text-center textGray fw-normal">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolor
              voluptatem quisquam vero aliquid alias ipsam sunt. Minima id
              distinctio quod dignissimos corporis eligendi mollitia ratione at
              maxime? Corporis temporibus voluptatem qui eveniet suscipit.
            </div>
          </div>
        </div>
      </div>
