...
const HotelGuests = () => {
  ...
  const onChildrenIncrement = () => dispatch(hotelSearchActions.incrementChildren());
  const onChildrensDecrement = () => dispatch(hotelSearchActions.decrementChildren());
          ...
          {hotelSearch.childs.length > 0 && (
            <div>
              ...
              <p className="text-muted fw-light">
                To find a place to stay that fits your entire group along with correct prices, we
                need to know how old your children will be at check-out.
              </p>
            </div>
          )}
        </div>
