...
import FoxCardRating from "@/components/cards/FoxCard/FoxCardRating";
...
const HotelRoomInfo = ({ room }: { room: any }) => {
  ...
  return (
    <>
      <button
        className="foxBtn mainBtn smBtn w-100"
            ...
            <div className="row text-start">
              ...
              <div className="col-7">
                ...
                <p className="fw-light mb-2">
                  ...
                  Debitis consequatur sapiente sunt saepe ab. Quam quis ipsum et
                  reiciendis vitae.
                </p>
